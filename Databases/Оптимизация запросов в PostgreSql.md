...
11)PostgreSQL перебирает все планы? Если да, оптимально ли это?
...
12)Как получить план выполнения в PostgreSQL?
...
13)Чем отличаются EXPLAIN от EXPLAIN ANALYZE?

EXPLAIN ANALYZE добавляет к EXPLAIN реальное время выполнения всех действий

--------------------------------------------------------------------------------------------------------------------

14)Селективность индексов, что это?
...
16)Использование индексов для оптимизации.
...
17)Не Использование индексов для оптимизации.
...
20)Длинные запросы и соединения хешированием
...
21)Длинные запросы и порядок соединений
...
22)Длинные запросы: Что такое полусоединение и антисоединение?
...
23)Длинные запросы: Использование операций над множествами
...
24)Длинные запросы: Избегаем многократного сканирования
...
26)Общие табличные выражения (CTE)
...
27)Материализованные представления
...
29)Два способа оптимизации модификации данных
