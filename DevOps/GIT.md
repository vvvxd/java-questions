...
Таким образом, дерево — это как папка в файловой системе. Оно указывает на файлы (blob'ы) и другие папки (другие деревья).
...
Когда вы делаете новый коммит, происходит следующее:
