...
- [JDK, JRE, JVM, JIT и Java 11: Как связаны между собой эти аббревиатуры и что изменилось в Java 11?](#jdk-jre-jvm-jit-и-java-11-как-связаны-между-собой-эти-аббревиатуры-и-что-изменилось-в-java-11)
- [Расскажите про загрузчик классов в JVM](#расскажите-про-загрузчик-классов-в-jvm)
- [Какие области памяти есть в JVM?](#какие-области-памяти-есть-в-jvm)
- [Краткая характеристика областей памяти JVM?](#краткая-характеристика-областей-памяти-jvm)
- [Расскажите про Execution Engine в JVM?](#расскажите-про-execution-engine-в-jvm)
- [Что такое режимы AOT-компиляции в JVM?](#что-такое-режимы-aot-компиляции-в-jvm)
- [Как происходит сборка мусора (Garbage Collection) в JVM?](#как-происходит-сборка-мусора-garbage-collection-в-jvm)
- [Какие есть алгоритмы сборки мусора в JVM?](#какие-есть-алгоритмы-сборки-мусора-в-jvm)
- [Когда какой сборщик мусора использовать?](#когда-какой-сборщик-мусора-использовать)
- [Тюнинг JVM, что можно настроить?](#тюнинг-jvm-что-можно-настроить)
- [Основные настройки JVM?](#основные-настройки-jvm)
- [Какие есть встроенные средства мониторинга (JMX, JFR, инструменты)?](#какие-есть-встроенные-средства-мониторинга-jmx-jfr-инструменты)
- [Как происходит процесс запуска JVM?](#как-происходит-процесс-запуска-jvm)
- [Как происходит инициализация JVM?](#как-происходит-инициализация-jvm)
- [Как происходит загрузка главного класса?](#как-происходит-загрузка-главного-класса)
- [Как происходит инициализация классов и запуск main?](#как-происходит-инициализация-классов-и-запуск-main)
- [Какая роль JIT/AOT при старте (Cold vs Warm start)?](#какая-роль-jitaot-при-старте-cold-vs-warm-start)
- [Какие финальные шаги запуска JVM?](#какие-финальные-шаги-запуска-jvm)
